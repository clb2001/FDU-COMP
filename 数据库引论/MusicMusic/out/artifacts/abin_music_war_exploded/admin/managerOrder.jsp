...
<body>
	...
	<script type="text/javascript">
		function fahuo(order_id) {
			window.location.href = "${pageContext.request.contextPath}/order/OrderServlet?op=delivery&order_id="
					+ order_id;
			alert("发货成功！！");
		}
	</script>
		...
		<c:forEach items="${orders}" var="os" varStatus="vs">
			<tr class="active">
				...
				<c:if test="${os.status==0}">
					<td>未发货</td>
					<td><a href="javascript:fahuo('${os.order_id}')">发货</a></td>
				</c:if>
