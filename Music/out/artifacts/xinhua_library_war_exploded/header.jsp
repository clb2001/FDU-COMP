...
<head>
    ...
    <title>桃花源网上书城-芳草鲜美，落英缤纷，怡然自乐</title>
    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a href="<%=basePath%>/client/ClientServlet?op=category"><img style="background-size:contain;height: 50px;width: 200px"
                                                       src="<%=basePath%>/img/personIndex.jpg" />
                </a>
                <c:if test="${!empty user}">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;欢迎您：<span
                    style="color: red; font-weight: bold">${sessionScope.user.name}</span>&nbsp;&nbsp;&nbsp;&nbsp;在桃花源畅游书海。
