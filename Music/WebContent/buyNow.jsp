<%@ page import="cn.xh.domain.Music" %>
...
<%
	...
	Cart cart = (Cart) session.getAttribute("buyNowMusic");
...
<body>
	...
	<jsp:include page="/header1.jsp"></jsp:include>
		<table class="table table-bordered table-hover"
			...
			<c:forEach items="${buyNowMusic.items}" var="c" varStatus="vs">
				<tr class="active">
	...
	<script type="text/javascript">
		...
		function delOneItem(music_id) {
			...
			if (sure) {
				window.location.href = "${pageContext.request.contextPath}/client/ClientServlet?op=delItem&music_id=" + music_id;
				alert("删除成功！！");
			}
		}
	</script>
