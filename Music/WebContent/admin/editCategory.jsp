...
<body>
	...
	<div>
		<p style="font-size: 25px; margin-top: 20px; margin-left: 42px">编辑音乐分类信息</p>
	</div>
	<hr
	...
	<div style="margin-top: 200px; margin-left: 430px">
		<form action="<%=basePath%>/admin/ManagerServlet?op=editCategory"
			...
			<div class="form-group">
				<label>音乐分类描述：</label> <input type="text" class="form-control"
					id="category_description" name="category_description"
					value="${category.category_description}" style="width: 700px">
			</div>
			<br>
